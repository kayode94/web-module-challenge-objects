...
function makeReview(name, rating, feedback){
  return {name, rating, feedback};
}

console.log(makeReview('Kay', 4, 'Cool vibe, great food'));
...
function addFeedback(array/*the array we want to edit*/, index/*the index of the array*/, feedback/*the value we want to change*/){
  array[index].feedback = feedback;
  return array;
}

console.log(addFeedback(reviews/*the first parameter*/, 7/*the second parameter*/, "this place is chill with really cool people, great for getting work done on weekdays"/*the third parameter*/));
